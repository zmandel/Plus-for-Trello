...
del sw.tmp
\bin\sed "s/css\/jquery\.mobile\.icons\.min\.css/https:\/\/cdnjs\.cloudflare\.com\/ajax\/libs\/jquery-mobile\/1\.4\.5\/jquery\.mobile\.icons\.min\.css/; s/css\/jquery\.mobile\.structure-1\.4\.5\.min\.css/https:\/\/cdnjs\.cloudflare\.com\/ajax\/libs\/jquery-mobile\/1\.4\.5\/jquery\.mobile\.structure\.min\.css/; s/js\/lib\/jquery\.js/https:\/\/cdnjs\.cloudflare\.com\/ajax\/libs\/jquery\/1\.7\.1\/jquery\.min\.js/; s/js\/lib\/jquery\.mobile-1\.4\.5\.min\.js/https:\/\/cdnjs\.cloudflare\.com\/ajax\/libs\/jquery-mobile\/1\.4\.5\/jquery\.mobile\.min\.js/" service-worker.js > sw.tmp
del service-worker.js
rename sw.tmp service-worker.js
pause
del index.html
del service-worker.js
