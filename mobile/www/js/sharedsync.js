...
var g_dateMinTransferInPast = new Date(2017, 8, 15);
...
function readTrelloCommentDataFromAction(action, cardTitle, rgKeywords, alldataUnused, usersMap, idMemberMapByName) {
    var tableRet = [];
    var id = action.id;
    var from = null;
